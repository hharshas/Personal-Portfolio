...
Command: npx gltfjsx@6.2.4 649db0afb42628bd95b9f230.glb
*/
...
export function Avatar(props) {
  ...
  const {animation} = props;
    ...
    const group = useRef()
  const { nodes, materials } = useGLTF('models/649db0afb42628bd95b9f230.glb');
  ...
  useFrame((state)=>{
    ...
    if( cursorFollow){
    const target = new THREE.Vector3(state.mouse.x, state.mouse.y,1); //based on xy
...
useGLTF.preload('models/649db0afb42628bd95b9f230.glb')
